public class SeatingGridOptimizer {
    ...
    // Computes average of a single row, handling jagged rows[cite: 6]
    ...
    public static String classifyRows(int[][] seatingScores, int threshold) {
        ...
        for (int i = 0; i < seatingScores.length; i++) {
            ...
            String zone = (avg >= threshold) ? "Buzzing Zone" : "Quiet Zone"; //[cite: 6]
    ...
    public static void main(String[] args) {
        ...
        // Output: Row 0: Quiet Zone | Row 1: Buzzing Zone | Row 2: Quiet Zone[cite: 6]
    }
}